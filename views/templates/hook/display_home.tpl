...
<div class="hero-of-the-month-wrapper {if $layout_type == 'full'}full-width{else}boxed{/if}" style="background-color: {$color1|escape:'html':'UTF-8'};">
    <div class="hero-of-the-month-container {if $is_custom_image_empty} no-image{/if}">
        ...
        {if $hero_product->id_image}
            <div class="hero-content-right">
                <img src="{$hero_custom_image|escape:'html':'UTF-8'}" alt="{$hero_product->name|escape:'html':'UTF-8'}" class="img-fluid" height="250" width="250">
            </div>
        {/if}
    </div>
</div>
